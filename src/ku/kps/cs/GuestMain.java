...
public class GuestMain {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GuestMain window = new GuestMain();
	...
	private void initialize() {
		...
		btnBuy_1.setBounds(36, 458, 89, 23);
		panelVga.add(btnBuy_1);
		...
		btnBuy_2.setBounds(270, 233, 89, 23);
		panelVga.add(btnBuy_2);
		...
		btnBuy_3.setBounds(540, 233, 89, 23);
		panelVga.add(btnBuy_3);
		...
		btnBuy_4.setBounds(49, 241, 89, 23);
		panelHdd.add(btnBuy_4);
		...
		btnBuy_5.setBounds(49, 466, 89, 23);
		panelHdd.add(btnBuy_5);
		...
		btnBuy_6.setBounds(283, 241, 89, 23);
		panelHdd.add(btnBuy_6);
		...
		btnBuy_7.setBounds(553, 241, 89, 23);
		panelHdd.add(btnBuy_7);
		...
		JButton btnBuy_8 = new JButton("Buy");
		btnBuy_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_8.setBounds(49, 248, 89, 23);
		panelPsu.add(btnBuy_8);
		...
		JButton btnBuy_9 = new JButton("Buy");
		btnBuy_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_9.setBounds(49, 473, 89, 23);
		panelPsu.add(btnBuy_9);
		...
		JButton btnBuy_10 = new JButton("Buy");
		btnBuy_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_10.setBounds(283, 248, 89, 23);
		panelPsu.add(btnBuy_10);
		...
		JButton btnBuy_11 = new JButton("Buy");
		btnBuy_11.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_11.setBounds(553, 248, 89, 23);
		panelPsu.add(btnBuy_11);
		...
		JButton btnBuy_12 = new JButton("Buy");
		btnBuy_12.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_12.setBounds(49, 248, 89, 23);
		panelCase.add(btnBuy_12);
		...
		JButton btnBuy_13 = new JButton("Buy");
		btnBuy_13.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_13.setBounds(49, 473, 89, 23);
		panelCase.add(btnBuy_13);
		...
		JButton btnBuy_14 = new JButton("Buy");
		btnBuy_14.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_14.setBounds(283, 248, 89, 23);
		panelCase.add(btnBuy_14);
		...
		JButton btnBuy_15 = new JButton("Buy");
		btnBuy_15.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_15.setBounds(553, 248, 89, 23);
		panelCase.add(btnBuy_15);
		...
		JButton btnBuy_16 = new JButton("Buy");
		btnBuy_16.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_16.setBounds(53, 248, 89, 23);
		panelMonitor.add(btnBuy_16);
		...
		JButton btnBuy_17 = new JButton("Buy");
		btnBuy_17.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_17.setBounds(53, 473, 89, 23);
		panelMonitor.add(btnBuy_17);
		...
		JButton btnBuy_18 = new JButton("Buy");
		btnBuy_18.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_18.setBounds(287, 248, 89, 23);
		panelMonitor.add(btnBuy_18);
		...
		JButton btnBuy_19 = new JButton("Buy");
		btnBuy_19.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "PLEASE LOGIN", "Error", JOptionPane.ERROR_MESSAGE);
			}
		});
		btnBuy_19.setBounds(557, 248, 89, 23);
		panelMonitor.add(btnBuy_19);
